...
exports.handleError = exports.errorPreset = exports.interactionCodeHandler = exports.getRedirectUrl = exports.toRequestData = undefined;
...
var toRequestData = exports.toRequestData = function toRequestData(providerCode, data) {
 ...
 */
var getRedirectUrl = exports.getRedirectUrl = function getRedirectUrl(url, parameters) {
 ...
 */
var interactionCodeHandler = exports.interactionCodeHandler = function interactionCodeHandler(_ref2) {
    var code = _ref2.code,
        preset = _ref2.preset,
        step = _ref2.step,
    ...
    switch (code) {
        case "ABORT":
            ...
            (0, _customFunctions.onAbort)({ params: { preset: preset, step: step, dispatch: dispatch }, customFunctions: customFunctions });
            break;
        ...
        case "TRY_OTHER_NETWORK":
            ...
            (0, _customFunctions.onReload)({ params: { preset: preset, step: step, dispatch: dispatch }, customFunctions: customFunctions });
            break;

        case "TRY_OTHER_ACCOUNT":
            // the end customer can retry and will see all network and nothing should change
            (0, _customFunctions.onRetry)({ params: { preset: preset, step: step, dispatch: dispatch }, customFunctions: customFunctions });
            break;
 ...
 */
var errorPreset = exports.errorPreset = function errorPreset(err, network) {
 ...
 * @param {Object} params.customFunctions
 */
var handleError = exports.handleError = function handleError(_ref3) {
    var err = _ref3.err,
        step = _ref3.step,
    ...
    (0, _customFunctions.onClientException)({ preset: data, step: step, dispatch: dispatch, customFunctions: customFunctions }); // run customized function to handle the error
};