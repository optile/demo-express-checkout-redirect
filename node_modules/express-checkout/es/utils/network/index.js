 ...
 * @returns {Promise} 
 */
export var sendData = function sendData(_ref2) {
    var url = _ref2.url,
        method = _ref2.method,
        body = _ref2.body;
 ...
 * @returns {Promise} 
 */
export var sendDataWithParams = function sendDataWithParams(_ref3) {
    var baseURL = _ref3.baseURL,
        method = _ref3.method,
        params = _ref3.params,
        body = _ref3.body;

    var _queryString$parseUrl = queryString.parseUrl(baseURL),
        url = _queryString$parseUrl.url,
        query = _queryString$parseUrl.query;

    var newQueryString = queryString.stringify(_extends({}, query, params));
