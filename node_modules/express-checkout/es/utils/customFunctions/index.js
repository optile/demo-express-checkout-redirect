...
var getExpressListInternal = function getExpressListInternal(_ref) {
    ...
    return sendDataWithParams({ baseURL: url, method: "GET", params: { clientId: clientId, country: country } });
};
...
var createExpressPresetInternal = function createExpressPresetInternal(_ref2) {
    ...
    return sendDataWithParams({ baseURL: url, method: "POST", params: { clientId: clientId }, body: transaction });
};
...
var updateExpressPresetInternal = function updateExpressPresetInternal(_ref3) {
    ...
    return sendData({ url: url, method: "PUT", body: transaction });
};
...
var cancelExpressPresetInternal = function cancelExpressPresetInternal(_ref4) {
    ...
    return sendData({ url: url, method: "POST", body: {} });
};
...
var getExpressPresetAccountInternal = function getExpressPresetAccountInternal(_ref5) {
    var url = _ref5.url;
    return sendDataWithParams({ baseURL: url, method: "GET", params: {} });
};
 ...
 */
export var useCorrectFunction = function useCorrectFunction(_ref12) {
    var params = _ref12.params,
        functionName = _ref12.functionName,
        customFunctions = _ref12.customFunctions;

    var customFunction = get(customFunctions, functionName, false);
    var internalFunction = get(internalFunctions, functionName, false);
 ...
 * @param {Object} params.customFunctions
 */
export var getExpressList = function getExpressList(_ref13) {
 ...
 * @param {Object} params.customFunctions
 */
export var createExpressPreset = function createExpressPreset(_ref14) {
 ...
 * @param {Object} params.customFunctions
 */
export var updateExpressPreset = function updateExpressPreset(_ref15) {
 ...
 * @param {Object} params.customFunctions
 */
export var cancelExpressPreset = function cancelExpressPreset(_ref16) {
 ...
 * @param {Object} params.customFunctions
 */
export var confirmExpressPreset = function confirmExpressPreset(_ref17) {
 ...
 * @param {Object} params.customFunctions
 */
export var onProceed = function onProceed(_ref18) {
 ...
 * @param {Object} params.customFunctions
 */
export var onAbort = function onAbort(_ref19) {
 ...
 * @param {Object} params.customFunctions
 */
export var onReload = function onReload(_ref20) {
 ...
 * @param {Object} params.customFunctions
 */
export var onRetry = function onRetry(_ref21) {
 ...
 * @param {Object} params.customFunctions
 */
export var getExpressPresetAccount = function getExpressPresetAccount(_ref22) {
 ...
 * @param {Object} params.customFunctions
 */
export var onClientException = function onClientException(_ref23) {
    var preset = _ref23.preset,
        step = _ref23.step,
        dispatch = _ref23.dispatch,
        customFunctions = _ref23.customFunctions;

    var onClientExceptionClient = get(customFunctions, "onClientException", false);
    var onErrorClient = get(customFunctions, "onError", false);
 ...
 * @param {Object} params.customFunctions
 */
export var onCustomerAbort = function onCustomerAbort(_ref24) {
